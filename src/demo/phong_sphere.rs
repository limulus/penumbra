...
#[wasm_bindgen]
pub struct PhongSphereRenderer {
    background: Canvas,
    canvas: Canvas,
    light_pos: Tuple,
...
#[wasm_bindgen]
impl PhongSphereRenderer {
    #[wasm_bindgen(constructor)]
    pub fn new(width: usize, height: usize, sensor_size: f32) -> PhongSphereRenderer {
        ...
        PhongSphereRenderer {
            ...
            light_pos: Tuple::point(-10.0, 10.0, 10.0),
    ...
    pub fn render(&mut self) {
        ...
        for i in 0..self.canvas.width {
            for j in 0..self.canvas.height {
                ...
                let ray = Ray::new(eye, (sensor_point - eye).normalize());
